...
func CreateSessionFromConfig(config *ClientConfig) (*gocql.Session, error) {
	...
	/*gocqlClusterConfig.SslOpts.CaPath = config.SslOpts.CaPath
	gocqlClusterConfig.SslOpts.CertPath = config.SslOpts.CertPath
	gocqlClusterConfig.SslOpts.KeyPath = config.SslOpts.KeyPath
	gocqlClusterConfig.SslOpts.EnableHostVerification = config.SslOpts.EnableHostVerification*/
